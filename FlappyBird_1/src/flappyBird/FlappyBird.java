	...
	public void repaint(Graphics g)
	{
		...
		for (Rectangle column : columns)
		{
			paintColumn(g, column);
                ...
                g.drawString("HAMLE :"+"  "+basmaSayısı, 50, 30);
                g.setColor(Color.RED);
                g.setFont(new Font("arial", Font.ITALIC, 30));
                g.drawString("SÜRE :"+"  "+time, 300, 30);
		...
		if (!started)
		{
			g.drawString("Bismillahirrahmanirrahim", 100, HEIGHT / 2 - 50);
                       
		}

		if (gameOver)
		{
			g.drawString("Ölenle ölünmez, devam!", 125, HEIGHT / 2 - 50);
                        basmaSayısı=0;
                        time=0;
